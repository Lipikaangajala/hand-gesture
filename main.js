...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/ilkv4QN40/model.json', modelLoaded);
...
function gotResults(error,results){
    if (error){
        ...
        console.log(results);
        document.getElementById("results_emoji_name").innerHTML = results[0].label;
        document.getElementById("results_emoji_name2").innerHTML = results[1].label;
